            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    ...
                    <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                        <thead>
                            <tr>
                                <th title="Field #1">Nội dung bình luận</th>
                                <th title="Field #2">id sản phẩm</th>
                                <th title="Field #3">Id Người bình luận</th>
                                <th title="Field #4">Thời gian bình luận</th>
                        ...
                        <?php foreach ($comments as $comment) : ?>
                            ...
                            <td><?php echo ($comment['created_at']) ?></td>
                                        ...
                                        <span style="overflow: visible; position: relative; width: 125px;">
                                            <a href="?role=admin&mod=conments&action=delete&id=<?php echo $comment['id'] ?>" onclick="return confirm('Bạn chắc chắn muốn xoá bình luận:  không?.')" class="btn btn-sm btn-clean btn-icon" title="Delete"> <span class="svg-icon svg-icon-md"> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
